...
byte setup_parameters(float parameters[]);
...
/**
 * @brief    standard hapkit hardware setup parameters
 * @param    Motor: actuator parameter struct
 * @return   none
 */
void standard_hapkit_setup(actuator *Motor){
  setTimer1Interrupt();
...
/**
 * @brief    setups Timer1 to run as an overflow interrupt at a rate of 1.008kHz 
...
/**
 * @brief    sets up pwm frequency for given pin
...
/**
 * @brief    initialize actuator for use with given pins
 * @param    m: actuator
...
/**
 * @brief    Receives setup parameters from serial link
 * @param    parameters: parameters of current system to be changed
 ...
 * @param    function: function currently being carried out
