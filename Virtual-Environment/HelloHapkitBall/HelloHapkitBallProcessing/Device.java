	...
	*/
	public Device(DeviceType device_type, byte deviceID, Board deviceLink){
     ...
     case HapticPaddle:
        ...
        device_component_auto_setup();
        //this.set_encoder_parameters(1, 0, 1024, 1); //hapkit specific
        params = new float[2];
        break;
...
/**
 ...
 /* Device communication and control functions *************************************************/
	...
	*/
	public void device_read_request(byte commType){
    	...
    	deviceLink.transmit(commType, deviceID, actuator_positions, encoder_request);
	}
