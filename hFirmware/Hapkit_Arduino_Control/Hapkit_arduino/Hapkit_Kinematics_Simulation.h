...
/* Setup declarations *******************************************************************************************/
/**
 * @brief    kinematics_simulation_setup, initializes MR  sensor to a starting position
 * @return   none
 */
void kinematics_simulation_setup(void){
...
/**
 * @brief    Compute position of system in meters
 * @note     Section 1
 * @return   none
 */
void computePosition(void){
...
/**
 * @brief    Rendering algorithm, determine force values that are needed and generates said forces
...
// Force output
/**
 * @brief    Force output to be generated
 * @note     Section 4
